...
function change_images(uploadid,returnid){
	...
	$.each( contents, function(i, n) {
		...
		str += "<li id='image"+ids+"'><input type='text' name='"+returnid+"_url[]' value='"+n+"' style='width:310px;' ondblclick='image_priview(this.value);' class='input-text'> <input type='text' name='"+returnid+"_alt[]' value='"+filename+"' style='width:160px;' class='input-text'> <a href=\"javascript:remove_div('image"+ids+"')\">移除</a> </li>";
		});
