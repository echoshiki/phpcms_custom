...
<table width="100%"  class="table_form">
  ...
  <tr>
    <th width="120">是否开启验证码</th>
    <td class="y-bg">
    <input name="setconfig[verification_code]" value="1"  type="radio"  <?php echo ($verification_code=='1') ? ' checked' : ''?>> <?php echo L('setting_yes')?>&nbsp;&nbsp;&nbsp;&nbsp;
    <input name="setconfig[verification_code]" value="0" type="radio"  <?php echo ($verification_code=='0') ? ' checked' : ''?>> <?php echo L('setting_no')?></td>
  </tr> 
  <tr>
  ...
  <tr>
    <th width="120">前台资源路径</th>
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[my_path]" id="my_path" size="50" value="<?php echo $my_path?>" /></td>
  </tr>
</table>
</div>
