...
<tr>
     <th>手机端显示：</th>
      <td>
	  <input type='radio' name='info[ismobilemenu]' value='1' <?php if($ismobilemenu) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[ismobilemenu]' value='0' <?php if(!$ismobilemenu) echo 'checked';?>> <?php echo L('no');?></td>
    </tr>
